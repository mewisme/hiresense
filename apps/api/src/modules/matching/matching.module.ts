...
@Module({
  ...
  providers: [MatchingService, MatchingRepository, JobSkillRequirementsService, BaselineSkillMatchingService, BaselineExperienceMatchingService, ApplicationSkillMatchingService],
  exports: [MatchingService, MatchingRepository, JobSkillRequirementsService, BaselineSkillMatchingService, BaselineExperienceMatchingService, ApplicationSkillMatchingService],
})
